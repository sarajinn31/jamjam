...
<section class="py-2">
    ...
    <div class="container">
        <div class="card rounded-0">
			...
			<div class="col my-3">
    <a href="#" class="btn btn-danger" id="cancel_order_button">Cancel Order</a>
</div>
        </div>
    </div>
</section>
...
$(document).ready(function() {
  $('#cancel_order_button').click(function(e) {
    e.preventDefault();
    // Perform any action you want to cancel the order, such as redirecting the user to another page
